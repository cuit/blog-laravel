...
@section('content')
    ...
    <div class="crumb_warp">
        ...
        <i class="fa fa-home"></i> <a href="{{url('home/info')}}">首页</a>  &raquo; 编辑文章
    </div>
    <!--面包屑导航 结束-->
    {{--<script>--}}
    ...
    <div class="result_wrap">
        ...
        <form action="{{url('home/article/'.$data->id)}}" method="POST" enctype="multipart/form-data">
            {{csrf_field()}}
            {{method_field('PUT')}}
            <table class="add_tab">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" class="lg" name="tag" style="width: 100%" value="{{$data->tag}}">
                        </td>
                    </tr>
                    {{--<tr>--}}
                        {{--<th>缩略图：</th>--}}
                    ...
                    <tr>
                        <th>文章封面：</th>
                        <td>
                            <input type="text" size="50" style="width: 80%" name="cover" value="{{$data->cover}}">
                    ...
                    <tr>
                        <th></th>
                        <td>
                            <img src="@if($data->cover != null)/laravel_blog/public/{{$data->cover}}@endif" alt="" id="cover" style="max-width: 350px; max-height:100px;">
                        </td>
                    </tr>
                    <tr>
                        <th>是否推荐</th>
                        <td>
                            <input type="radio" value="1" name="recommend" @if($data->recommend == 1) checked @endif>是&nbsp;&nbsp;
                            <input type="radio" value="0" name="recommend" @if($data->recommend == 0) checked @endif>否
                        </td>
                    </tr>
                    <tr>
                        <th>文章描述：</th>
                        <td>
                            <textarea name="description" style="width: 95%">{{$data->description}}</textarea>
                        </td>
                    </tr>
                    <tr>
                        <th>文章内容：</th>
                        <td>
                            <script id="editor" name="content" type="text/plain" style="width:800px;height: 500px">{!! $data->content !!}</script>
