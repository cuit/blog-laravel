...
@section('content')
    ...
    <div class="crumb_warp">
        ...
        <i class="fa fa-home"></i> <a href="{{url('home/info')}}">首页</a>  &raquo; 编辑友情链接
    </div>
    <!--面包屑导航 结束-->
	<!--结果集标题与导航组件 开始-->
    ...
    <div class="result_wrap">
        ...
        <form action="{{url('home/link/'.$data->id)}}" method="POST" >
            {{csrf_field()}}
            {{method_field('PUT')}}
            <table class="add_tab">
                <tbody>
                ...
                <tr>
                    <th>友情链接描述：</th>
                    <td>
                        <input type="text" class="lg" name="description" style="width: 100%" value="{{$data->description}}">
                    </td>
                </tr>
                <tr>
                    <th>友情链接排序：</th>
